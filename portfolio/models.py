...
class PortfolioWork(models.Model):
    ...
    specialist_liability = models.BooleanField(
        'Специалист принял ответственность',
        default=False,
    )
    liability_datetime = models.DateTimeField(
